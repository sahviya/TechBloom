...
export default function DirectPDFViewer({ book, onClose }: DirectPDFViewerProps) {
          ...
          <div className="flex-1 overflow-hidden">
            ...
            >
              <iframe
                ...
                onError={() => {
                  setError("Failed to load PDF. The file may not be accessible or your browser may not support PDF viewing.");
                  setLoading(false);
                }}
              />
            </div>
