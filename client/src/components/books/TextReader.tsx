...
export default function TextReader({ book, onClose }: TextReaderProps) {
  ...
  useEffect(() => {
    saveData();
  }, [currentPage, readingTheme, fontSize, bookmarks, highlights]);
      ...
      <DialogContent className="max-w-7xl w-full h-[90vh] p-0">
        ...
        <div className="flex-1 flex overflow-hidden">
          ...
          <div className="flex-1 overflow-hidden">
            <div 
              className={`w-full h-full p-8 overflow-y-auto ${getThemeClasses()}`}
